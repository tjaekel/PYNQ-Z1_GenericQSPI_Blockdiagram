...
#
# Script generated by Vivado on Sat Dec 14 18:27:02 -0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : QSPI_top.sh
...
#
# Usage        : QSPI_top.sh
#                QSPI_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                QSPI_top.sh [-reset_run]
#                QSPI_top.sh [-reset_log]
#                QSPI_top.sh [-help]
#
...
# script info
echo -e "QSPI_top.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./QSPI_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot QSPI_top xil_defaultlib.QSPI_top -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim QSPI_top -key {Behavioral:sim_1:Functional:QSPI_top} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb QSPI_top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./QSPI_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: QSPI_top.sh [-help]\n\
Usage: QSPI_top.sh [-step]\n\
Usage: QSPI_top.sh [-lib_map_path]\n\
Usage: QSPI_top.sh [-reset_run]\n\
Usage: QSPI_top.sh [-reset_log]\n\
Usage: QSPI_top.sh [-keep_index]\n\
Usage: QSPI_top.sh [-noclean_files]\n\n\

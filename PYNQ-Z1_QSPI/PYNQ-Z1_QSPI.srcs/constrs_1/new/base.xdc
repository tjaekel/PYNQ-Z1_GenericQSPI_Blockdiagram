...
#set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {spi_io1_i}]
#set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {spi_io1_o}]
##MISO
...
create_clock -period 20.0 -waveform {0.0 10.0} [get_ports QCLKfb_0]
##QD3..0
...
## SPI header
#set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports spi_io0_i];
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports spi_io0_o];
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports spi_sck_o];
#set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports spi_ss_o];
